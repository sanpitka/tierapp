...
public class Screenshots {
        ...
        if (screenshotDir.isDirectory()) {
            for (File imgFile : screenshotDir.listFiles()) {
                try {
                    ...
                    JOptionPane.showMessageDialog(window, "Error: " + e.getMessage(), "Error",
    ...
    /**
     * Set filename of the screenshot to the list name given by user. If the user
     * has not
    ...
    public Component openScreenshot(JFrame dialogOwner, String filename) {
        ...
        try {
            ...
            JOptionPane.showMessageDialog(dialogOwner, "There was an error: " + e.getMessage(), "Error",
                    JOptionPane.ERROR_MESSAGE);
        }
    ...
    public Boolean delete(JDialog dialog, String filename) {
        ...
        if (file.exists()) {
            int option = JOptionPane.showConfirmDialog(dialog, "Are you sure you want to delete " + filename + "?",
                    "Confirmation", JOptionPane.YES_NO_OPTION);
            if (option == JOptionPane.YES_OPTION) {
                if (file.delete()) {
                    JOptionPane.showMessageDialog(dialog, "File deleted successfully.", "Success",
